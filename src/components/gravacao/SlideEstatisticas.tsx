  ...
  return (
    <div className="flex w-full h-full gap-6">
      ...
      <div className="w-[30%] flex flex-col items-center justify-center gap-6">
        <div>
          <p className="text-purple-300/60 text-sm mb-3 tracking-wide text-center">Resultado</p>
        ...
        <div className="w-full space-y-1.5">
          <p className="text-purple-300/60 text-xs tracking-wide text-center mb-2">Indicadores</p>
