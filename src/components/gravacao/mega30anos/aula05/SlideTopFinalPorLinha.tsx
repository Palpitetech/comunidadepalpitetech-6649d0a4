...
import { topDezenaFinalPorLinha } from "./aula05Helpers";
...
export default function SlideTopFinalPorLinha({ concursos }: Props) {
  const dados = useMemo(() => topDezenaFinalPorLinha(concursos), [concursos]);
  ...
  return (
    <div className="w-full h-full flex flex-col pt-36 pb-6 px-4">
      <Mega30Header
        aula={5}
        estudoNome="Top dezena FINAL por linha"
        tipoAnalise="A dezena que mais foi a maior do sorteio em cada linha"
      />
