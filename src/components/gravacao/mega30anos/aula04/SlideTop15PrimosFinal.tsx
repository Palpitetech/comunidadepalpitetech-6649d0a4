...
import { TODOS_PRIMOS } from "./aula04Helpers";
...
const TITULO = "Top 15 dezenas PRIMAS para Mega Especial 30 anos / R$ 150 milhões";

export default function SlideTop15PrimosFinal({ concursos }: Props) {
  const top15 = useMemo(
    () =>
      calcularEstudo(concursos, {
        estudoId: "aula04-top15-primos",
        agrupamento: "dezena",
        periodo: { tipo: "total" },
        topN: 15,
        restringirA: TODOS_PRIMOS,
      }),
    [concursos],
  );
