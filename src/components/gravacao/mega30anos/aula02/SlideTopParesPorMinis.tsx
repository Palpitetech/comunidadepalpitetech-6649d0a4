...
import { PARES_MINI } from "./aula02Helpers";
...
export default function SlideTopParesPorMinis({ concursos, pagina }: Props) {
  ...
  return (
    <div className="w-full h-full flex flex-col pt-24 pb-4 px-4">
      <Mega30Header
        aula={2}
        estudoNome="Top dezenas PARES por MINI-QUADRANTE"
        tipoAnalise={`MQ ${inicio} a ${fim} — pare mais sorteado destacado`}
      />
