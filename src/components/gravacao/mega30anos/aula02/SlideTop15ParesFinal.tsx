...
import { TODAS_PARES } from "./aula02Helpers";
...
const TITULO = "Top 15 dezenas PARES para Mega Especial 30 anos / R$ 150 milhões";

export default function SlideTop15ParesFinal({ concursos }: Props) {
  const top15 = useMemo(
    () =>
      calcularEstudo(concursos, {
        estudoId: "aula02-top15-pares",
        agrupamento: "dezena",
        periodo: { tipo: "total" },
        topN: 15,
        restringirA: TODAS_PARES,
      }),
    [concursos],
  );
