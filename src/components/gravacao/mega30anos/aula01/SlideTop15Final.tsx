...
import { topDezenasGeral, type ConcursoMega } from "@/lib/megaEspecialEngine";
...
const TITULO = "Top 15 dezenas para Mega Especial 30 anos / R$ 150 milhões";

export default function SlideTop15Final({ concursos }: Props) {
  const top15 = useMemo(() => topDezenasGeral(concursos, 15), [concursos]);
