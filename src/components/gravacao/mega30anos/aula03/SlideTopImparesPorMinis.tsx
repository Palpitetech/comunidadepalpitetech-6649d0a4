...
import { IMPARES_MINI } from "./aula03Helpers";
...
export default function SlideTopImparesPorMinis({ concursos, pagina }: Props) {
  ...
  return (
    <div className="w-full h-full flex flex-col pt-24 pb-4 px-4">
      <Mega30Header
        aula={3}
        estudoNome="Top dezenas ÍMPARES por MINI-QUADRANTE"
        tipoAnalise={`MQ ${inicio} a ${fim} — ímpar mais sorteado destacado`}
      />
