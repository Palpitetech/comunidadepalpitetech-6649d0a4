...
interface SlideEstatisticasQuinaProps {
  dezenas: number[];
...
export default function SlideEstatisticasQuina({ dezenas, estatisticas, tendencias }: SlideEstatisticasQuinaProps) {
  ...
  return (
    <div className="flex w-full h-full gap-6">
      ...
      <div className="w-[30%] flex flex-col items-center justify-center gap-4">
        <div>
          <p className="text-indigo-300/60 text-sm mb-2 tracking-wide text-center">Resultado</p>
        ...
        <div className="w-full space-y-1.5">
          <p className="text-indigo-300/60 text-xs tracking-wide text-center mb-2">Indicadores</p>
      ...
      <div className="w-[70%] flex flex-col justify-center overflow-hidden">
        <p className="text-indigo-300/70 text-sm mb-4 tracking-wide">
