...
interface ModoSeletorFixasDuplaSenaProps {
  modo: "selecionar" | "fixar";
  onChange: (modo: "selecionar" | "fixar") => void;
}

export function ModoSeletorFixasDuplaSena({ modo, onChange }: ModoSeletorFixasDuplaSenaProps) {
  return (
    <div className="flex items-center justify-center gap-0.5 p-0.5 bg-muted rounded-lg flex-1 min-w-0">
      <button
        ...
        className={cn(
          ...
          modo === "selecionar"
            ? "bg-duplasena-primary text-duplasena-primary-foreground shadow-sm"
