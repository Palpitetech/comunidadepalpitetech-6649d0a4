...
interface ModoSeletorDesdobramentoDuplaSenaProps {
  modo: "fixar" | "excluir";
...
export function ModoSeletorDesdobramentoDuplaSena({
  modo,
  onModoChange,
  qtdFixas,
  qtdExcluidas,
}: ModoSeletorDesdobramentoDuplaSenaProps) {
  return (
    <div className="flex gap-2 p-1 bg-muted rounded-lg">
      ...
      <button
        ...
        className={cn(
          "flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-md text-sm font-medium transition-all",
          modo === "excluir"
            ? "bg-duplasena-excluida text-white shadow-sm"
            : "text-muted-foreground hover:text-foreground"
        )}
      >
        <X className="h-4 w-4" />
