...
export function FiltroDezenaSelectorMegaSena({
  label,
  description,
  value,
  onChange,
    ...
    <div className="space-y-3">
      ...
      >
        <div className="flex items-center space-x-2">
          <RadioGroupItem value="padrao" id={`megasena-${tipo}-padrao`} />
          <Label htmlFor={`megasena-${tipo}-padrao`} className="text-sm cursor-pointer">
            Padrão
          </Label>
        </div>
        <div className="flex items-center space-x-2">
          <RadioGroupItem value="sim" id={`megasena-${tipo}-sim`} />
          <Label htmlFor={`megasena-${tipo}-sim`} className="text-sm cursor-pointer">
            Sim
          </Label>
        </div>
        <div className="flex items-center space-x-2">
          <RadioGroupItem value="nao" id={`megasena-${tipo}-nao`} />
          <Label htmlFor={`megasena-${tipo}-nao`} className="text-sm cursor-pointer">
            Não
          </Label>
        </div>
      </RadioGroup>

      {/* Seletor de dezenas - Grid 10x6 para Mega Sena */}
      {value === "sim" && (
