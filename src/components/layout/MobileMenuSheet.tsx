                 ...
                 <Accordion type="single" collapsible>
                   <AccordionItem value="quina" className="border-none">
                     <AccordionTrigger className="py-3 text-base hover:no-underline hover:text-primary">
                      ...
                      <AccordionContent className="pb-0">
                        <div className="pl-8 space-y-0">
                          <Link to="/quina/analise-do-dia" onClick={(e) => handleGatedClick(e, "/quina/analise-do-dia")}>
                            <div className="py-2.5 text-[15px] text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2">
                              Análise do Dia
                              {renderBadge("/quina/analise-do-dia")}
                            </div>
                          </Link>
                          ...
                          <Link to="/quina/frequencia" onClick={(e) => handleGatedClick(e, "/quina/frequencia")}>
                           ...
                           <Link to="/quina/tabela-movimentacao" onClick={(e) => handleGatedClick(e, "/quina/tabela-movimentacao")}>
                              <div className="py-2.5 text-[15px] text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2">
                                Tabela Movimentação
                           ...
                           <Link to="/quina/desdobramento" onClick={(e) => handleGatedClick(e, "/quina/desdobramento")}>
                              <div className="py-2.5 text-[15px] text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2">
                                Desdobramento
                                {renderBadge("/quina/desdobramento")}
                              </div>
                            </Link>
                         </div>
                      </AccordionContent>
