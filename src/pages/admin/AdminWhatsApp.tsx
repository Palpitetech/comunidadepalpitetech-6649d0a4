...
const TAB_TITLES: Record<string, string> = {
  ...
  retargeting: "Automações de CRM",
  "disparo-grupo": "Disparo em Massa (Grupos)",
  "monitor-grupos": "Monitoramento de Grupos",
  aquecimento: "Aquecimento de Chips",
  grupos: "Gestão de Grupos",
  "smart-links": "Rastreamento Smart Links",
