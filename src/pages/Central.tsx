    ...
    <MainLayout pageTitle="Central">
      <div className="container-senior pt-8 pb-12 space-y-10 px-4">
        ...
        <div className="flex justify-center w-full pt-4">
          <Button 
            variant="outline" 
            className="w-[85%] sm:w-[70%] h-auto py-5 px-6 bg-[#25D366] hover:bg-[#20ba5a] text-white border-none shadow-xl flex flex-col items-center gap-1 rounded-[2rem] group active:scale-95 transition-all"
          >
