...
const tools = [
  {
    ...
    icon: Target,
    path: "/megasena/analise-do-dia",
    accent: "bg-[hsl(125,70%,40%)]/10 text-[hsl(125,70%,40%)]",
  },
  {
    title: "Resultados",
    description: "Histórico completo de resultados da Mega Sena",
    icon: BarChart3,
    path: "/megasena/resultados",
    accent: "bg-[hsl(125,70%,40%)]/10 text-[hsl(125,70%,40%)]",
  },
  {
    title: "Tendências",
  ...
  },
  {
    ...
    icon: BarChart3,
    path: "/megasena/frequencia-dezenas",
    accent: "bg-[hsl(125,70%,40%)]/10 text-[hsl(125,70%,40%)]",
  },
  {
    ...
    icon: Target,
    path: "/megasena/dezenas-por-posicao",
    accent: "bg-[hsl(125,70%,40%)]/10 text-[hsl(125,70%,40%)]",
  },
  {
  ...
  },
  {
    ...
    icon: Table2,
    path: "/megasena/tabela-movimentacao",
    accent: "bg-[hsl(125,70%,40%)]/10 text-[hsl(125,70%,40%)]",
  },
  {
