...
const THEME_COLOR = "35, 80%, 50%"; // Laranja Dia de Sorte (H S L)

const tools: HubTool[] = [
  { title: "Resultados", description: "Histórico completo de resultados do Dia de Sorte", icon: BarChart3, path: "/diadesorte/resultados" },
  // Mais ferramentas podem ser adicionadas aqui conforme forem desenvolvidas
];

export default function HubDiaDeSorte() {
  return (
    <MainLayout pageTitle="Dia de Sorte" hideBackButton>
      <div className="max-w-2xl mx-auto px-4 py-6">
        <div className="mb-6">
          ...
          <p className="text-sm text-muted-foreground">
            Todas as ferramentas de análise e geração para o Dia de Sorte
          </p>
        </div>
