...
DECLARE
  ...
  v_pix_codigo text;
  v_link_sala_secreta_mega text := 'https://www.palpitetech.com.br/g/ms-sala-secreta?utm_source=whatsapp&utm_medium=lead_retarget&utm_campaign=maratona_mega_30anos';
  v_link_sala_vip_mega text := 'https://www.palpitetech.com.br/g/ms-sala-vip?utm_source=whatsapp&utm_medium=sale_confirmed&utm_campaign=aula_mega_especial_vip';
BEGIN
