// =============================================================================
// Engine Lotofácil — TODA a lógica determinística + prompts + validação
// Movido verbatim de generate-guide-post/index.ts (refatoração Fase 1).
// Comportamento idêntico — apenas isolado em módulo próprio.
// =============================================================================
...
// =============================================================================
// VALIDADOR ANTI-ALUCINAÇÃO + SANITIZAÇÃO + FALLBACK
// =============================================================================
...
// =============================================================================
// LIMITE DE CONTEÚDO POR TIPO (extraído do switch inline do antigo handler)
// =============================================================================
function limiteConteudoLotofacil(tipoPost: string): number {
  if (tipoPost === "analise_ciclo" || tipoPost === "analise_moldura") return 2000;
  if (
    tipoPost === "analise_movimentacao" ||
    tipoPost === "analise_repetidas" ||
    tipoPost === "analise_linhas" ||
    tipoPost === "analise_colunas" ||
    tipoPost === "analise_posicoes_iniciais" ||
    tipoPost === "analise_posicoes_finais"
  ) return 2200;
  return 1500;
}
...
// =============================================================================
// TIPOS SUPORTADOS (extraído dos mapas titulosBase/titulos do prompt)
// =============================================================================
const TIPOS_SUPORTADOS_LOTOFACIL = [
  "analise_ciclo",
...
// =============================================================================
// FACHADA — implementa o contrato GuideEngine
// =============================================================================
export const lotofacilEngine: GuideEngine = {
  loteria: "lotofacil",
  tiposSuportados: () => TIPOS_SUPORTADOS_LOTOFACIL,
  montarFatos: (tipoPost, concursos, historicoCiclos) =>
    montarFatos(tipoPost, concursos, historicoCiclos),
  montarTituloDeterministico,
  montarPrompt: (tipoPost, fatos, ultimoConcurso) =>
    montarPrompt(tipoPost, fatos, ultimoConcurso),
  limiteConteudo: limiteConteudoLotofacil,
