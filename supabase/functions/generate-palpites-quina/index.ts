// =============================================================================
// /gerador-quina — wrapper sobre o pipeline determinístico shared.
// =============================================================================
...
serve(async (req) => {
  ...
  try {
    ...
    const qtdDezenas = clampQtdDezenas("quina", Number(body.qtdDezenas));
    ...
    const result = await gerarPalpitesDeterministicos({
      ...
      edgeFunction: "generate-palpites-quina",
    });
    ...
    console.error("[generate-palpites-quina] erro:", error);
