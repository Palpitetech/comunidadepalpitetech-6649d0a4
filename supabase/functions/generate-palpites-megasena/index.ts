// =============================================================================
// /gerador-megasena — wrapper sobre o pipeline determinístico shared.
// =============================================================================
...
serve(async (req) => {
  ...
  try {
    ...
    const qtdDezenas = clampQtdDezenas("megasena", Number(body.qtdDezenas));
    ...
    const result = await gerarPalpitesDeterministicos({
      ...
      edgeFunction: "generate-palpites-megasena",
    });
    ...
    console.error("[generate-palpites-megasena] erro:", error);
